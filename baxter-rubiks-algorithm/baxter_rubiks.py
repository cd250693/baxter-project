...
class Baxter(object):
    ...
    def __init__(self):
        ...
        self.right_pickup_cube = {
            'right_e0': -0.9265243948242188,
            'right_e1': 0.9165535197143555,
            'right_s0': 1.3084856105712892,
            'right_s1': -0.4249126777587891,
            'right_w0': 0.8348690428527833,
            'right_w1': 1.366776880444336,
            'right_w2': -0.22511168036499024}
        ...
        self.left_cube = {
            'left_e0': -0.2323980890991211,
            'left_e1': 2.2031799040832523,
            'left_s0': -0.3409272297180176,
            'left_s1': -1.1370632577209474,
            'left_w0': -1.3050341538024903,
            'left_w1': 1.6287040996765139,
            'left_w2': -0.5449466742736817}

        # joint angles for left limb central and cube flat rotation
        self.left_flat_central = {
            'left_e0': -0.5867476506958008,
            'left_e1': 1.2206652105651856,
            'left_s0': -0.33210684019775394,
            'left_s1': -0.5721748332275391,
            'left_w0': -0.7857816576965333,
            'left_w1': 2.0900488211059574,
            'left_w2': -1.0339030498535158}

        self.left_flat_cube = {
            'left_e0': -0.5748592996032715,
            'left_e1': 1.5520050603698732,
            'left_s0': -0.38272820614013675,
            'left_s1': -0.7585534987426759,
            'left_w0': -0.8156942830261231,
            'left_w1': 1.861102188775635,
            'left_w2': -0.8877913799743653}
        ...
        self.left_vertical_cube = {
            'left_e0': -1.1850001572875977,
            'left_e1': 1.4200827127624513,
            'left_s0': -0.39461655723266603,
            'left_s1': 0.6082233817016602,
            'left_w0': -0.9629564384948731,
            'left_w1': 1.9581264734985353,
            'left_w2': -0.3252039266601563}
